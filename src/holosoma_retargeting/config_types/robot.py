...
_ROBOT_DEFAULTS: dict[str, RobotDefaults] = {
    ...
    "v2": {"robot_dof": 14, "robot_height": 1.46, "object_name": "ground"},
}
...
class RobotConfig:
    ...
    def _robot_urdf_file(self) -> str:
        ...
        if self.robot_type == "g1_23dof":
            return "models/g1/g1_23dof_rev_1_0.urdf"
